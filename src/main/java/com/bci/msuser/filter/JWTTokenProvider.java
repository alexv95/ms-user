...
public class JWTTokenProvider {
    /**
     * this should be stored in secret on config server or vault
     * **/
    @Value("${jwt.secret}")
    ...
    * */
    ...
    /**
     * is tokenValid requires the name of the user and currentToken
     * */
    ...
    /**
     * return the username from a token
     * */
